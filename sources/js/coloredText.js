//code format: #color:colorname{text} or #RRGGBB{text}
//example: #color:red{This is red text} or #FF0000{This is red text}
//code from https://github.com/tanhHeng/GraduateTextsInTechnicalMC/blob/main/source/js/coloredText.js
(function() {
